...
import { getPendingComplaintsByAdmin, getSolvedComplaintsByAdmin } from '../../services/Admin';
const SolvedComplaintsAdmin = () => {
  ...
  const handleGetAllComplaintsUser=()=>{
    setIsLoading(true)
    getSolvedComplaintsByAdmin(admin?.userDetails?.apartmentId).then((res)=>{
      setIsLoading(false)
      if (res?.status==200) {
...
export default SolvedComplaintsAdmin;
