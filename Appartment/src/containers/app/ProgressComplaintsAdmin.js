...
import { getInprogressComplaintsByAdmin, getPendingComplaintsByAdmin } from '../../services/Admin';
const ProgressComplaintsAdmin = () => {
  ...
  const handleGetAllComplaintsUser=()=>{
    setIsLoading(true)
    getInprogressComplaintsByAdmin(admin?.userDetails?.apartmentId).then((res)=>{
      setIsLoading(false)
      if (res?.status==200) {
                ...
                onPress={()=>navigation.navigate("ComplaintDetailAdmin",{
                  ...
                  <Text
                    ...
                    <Text
                      ...
                      Appartment No :{' '}
                      <Text style={{color: Colors.blue}}>{item?.appartmentNo}</Text>
                    </Text>
                  <View
                    style={{
                      flexDirection: 'row',
                    ...
                    <Text
                      ...
                      Token No.{' '}
                      <Text style={{color: Colors.blue}}>{item?.complaintId}</Text>
                    </Text>
                    <Text
                      style={{
                        color: Colors.headingColor,
...
export default ProgressComplaintsAdmin;
